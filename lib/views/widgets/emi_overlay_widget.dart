...
class EmiOverlayWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: PopScope(
        canPop: false, // CRITICAL: Prevent back button from dismissing overlay
        onPopInvokedWithResult: (bool didPop, dynamic result) {
          // Explicitly prevent back button - overlay should NEVER be dismissed by back button
          debugPrint('[EmiOverlay] ========== BACK BUTTON PRESSED ==========');
          debugPrint('[EmiOverlay] didPop: $didPop - BLOCKED (overlay cannot be dismissed)');
        ...
        child: Container(
          ...
          child: GestureDetector(
            onTap: () {
              ...
              // Do nothing - overlay should not be dismissible
              debugPrint('[EmiOverlay] Tap detected outside - IGNORED (overlay cannot be dismissed)');
            },
            child: Center(
          child: Container(
            ...
            constraints: BoxConstraints(
              maxWidth: Responsive.isDesktop(MediaQuery.of(context).size.width) ? 500 : double.infinity,
            ),
              ...
              children: [
                ...
                Container(
                  ...
                  child: Icon(
                    ...
                    size: Responsive.spacing(context, mobile: 48, tablet: 52, desktop: 56),
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        ...
                        style: GoogleFonts.poppins(
                          fontSize: Responsive.fontSize(context, mobile: 32, tablet: 36, desktop: 40),
                          fontWeight: FontWeight.bold,
